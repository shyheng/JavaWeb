		...
		var i = n(2),
			...
			u = {
				...
				transformRequest: [function(e, t) {
					return s(t, "Accept"), s(t, "Content-Type"), i.isFormData(e) || i
						.isArrayBuffer(e) || i.isBuffer(e) || i.isStream(e) || i.isFile(e) || i
						.isBlob(e) ? e : i.isArrayBufferView(e) ? e.buffer : i
				...
				if (l.open(e.method.toUpperCase(), i(y, e.params, e.paramsSerializer), !0),
					l.timeout = e.timeout, l.onreadystatechange = function() {
						if (l && 4 === l.readyState && (0 !== l.status || l.responseURL &&
							...
							var n = "getAllResponseHeaders" in l ? a(l
					...
					var g = n(21),
						v = (e.withCredentials || u(y)) && e.xsrfCookieName ? g.read(e
			...
			return {
				write: function(e, t, n, o, i, s) {
					...
					a.push(e + "=" + encodeURIComponent(t)), r.isNumber(n) && a.push(
							...
							"path=" + o), r.isString(i) && a.push("domain=" + i), s === !0 && a
